...
class VideoDetail extends React.Component {
    ...
    populateItem() {
        ...
        FetchPost("/nova/embedding/get-task", {
            ...
            <div className="novavideodetail">
                ...
                <div>
                    <div className='video'>
                        ...
                        <div className="processing">{this.state.item.EmbedCompleteTs && "Embedding time: " + this.calculateTimeDelta(this.state.item.RequestTs, this.state.item.EmbedCompleteTs)}</div>
